...
set "DEFAULT_ARGS=--out results/depcs-fiveway-parallel-merkle-nv18-24-w2-w4 --fair-sequential --depcs-nv-range 18..24 --depcs-workers 2,4 --depcs-backends basefold:8,deepfold:2 --depcs-opening protocol11 --ligesis-nvs 18,19,20,21,22,23,24 --ligesis-parties-list 2,4 --external-pcs-schemes dfrittata-pcs,dpip-fri-pcs --pcs-queries 1 --repeats 1"
